        ...
        <form onSubmit={handleSubmit} className="space-y-6 pb-28 md:pb-6">
            ...
            <section className="space-y-4 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input type="number" inputMode="numeric" value={form.age} onChange={(e) => updateField("age", e.target.value)} className={inputClass("age")} placeholder="Your age" min="18" max="120" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input type="email" inputMode="email" autoComplete="email" value={form.email} onChange={(e) => updateField("email", e.target.value)} className={inputClass("email")} placeholder="your@email.com" />
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <section className="bg-muted/50 rounded-xl p-5 md:p-6 space-y-4">
          ...
          <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-border bg-background/95 backdrop-blur px-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:static md:border-0 md:bg-transparent md:p-0 md:pt-4">
            <div className="max-w-2xl mx-auto flex items-center gap-3">
              {step > 0 ? (
                <Button
                  ...
                  variant="outline"
                  onClick={goBack}
                  className="flex-1 md:flex-none h-12 rounded-xl font-semibold"
                >
