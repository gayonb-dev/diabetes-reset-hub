...
const WhatYouGetSection = ({ onOpenPayment }: WhatYouGetSectionProps) => {
  const benefits = [
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-primary/10 to-secondary/10 border-2 border-primary/20 hover:border-primary rounded-xl p-6 transition-colors"
              >
